...
# [[ -n "$keys[Alt+Right]"   ]] && bindkey "$keys[Alt+Right]"   cd-forward          #Alt-Right 
# [[ -n "$keys[Alt+Left]"   ]] && bindkey "$keys[Alt+Left]"   cd-back          #Alt-Right 
...
# ========================== Bindings ==========================
  ...
  'up'              up-line-or-beginning-search    # prev command in local history
  'down'                    down-line-or-beginning-search  # next command in local history
  '^[[1~'                   beginning-of-line                    # go to the beginning of line
  '^[[F'                    end-of-line
  ...
  'M-left'              cd-back
  'M-up'              cd-up
  'M-down'            fzf-cd-widget
  'M-right'             cd-forward
  'C-right'              forward-word                         # go forward one word
  'C-left'               backward-word                        # go backward one word
  'C-bs'                      backward-kill-word                   # delete previous word
  'C-del'                kill-word                            # delete next word
  'C-b'                    zbrowse
  'Esc-e'                 wfxr::fzf-file-edit-widget
  'Esc-f'                 list-keys             # list keybindings in mode
  # 'M-r'                   per-dir-fzf
  'M-S-R'                 fzf-history-widget
  'M-o'                   fzf-clipboard            # greenclip fzf
  'C-]'                   macho-zle
